...
// HasRequesters applies the HasEdge predicate on the "requesters" edge.
func HasRequesters() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(RequestersTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2M, true, RequestersTable, RequestersPrimaryKey...),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasRequestersWith applies the HasEdge predicate on the "requesters" edge with a given conditions (other predicates).
func HasRequestersWith(preds ...predicate.User) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(Table, FieldID),
...
// HasRequesting applies the HasEdge predicate on the "requesting" edge.
func HasRequesting() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(RequestingTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2M, false, RequestingTable, RequestingPrimaryKey...),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasRequestingWith applies the HasEdge predicate on the "requesting" edge with a given conditions (other predicates).
func HasRequestingWith(preds ...predicate.User) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(Table, FieldID),
